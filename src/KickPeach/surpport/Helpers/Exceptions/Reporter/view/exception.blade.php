...
<title><?php echo htmlspecialchars($data['type'])?></title>
...
<?php
//初始化
$this->maxSourceLines = 25;
$this->maxTraceSourceLines = 10;
?>
<div class="container">
        ...
        <div class="source">
                <p class="file"><?php echo htmlspecialchars($data['file'])."({$data['line']})"?></p>
                ...
                <tr class="trace <?php echo $cssClass; ?>">
                        ...
                        <td class="content">
                                <div class="trace-file">
                                        ...
                                        if (!empty($trace['args'])) {
                                                echo htmlspecialchars($this->argumentsToString($trace['args']));
                                        }
                                                echo ')';
                                        ?>
                                </div>
                                ...
                                <?php
                                if ($hasCode) {
                                    echo $this->renderSourceCode($trace['file'], $trace['line'], $this->maxTraceSourceLines);
                                }
                                ?>
                        </td>
                </tr>
